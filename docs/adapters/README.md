...
| Codex CLI | `~/.codex/skills/agent-foundry/` via symlink + `agents/openai.yaml` per-agent manifests | **🟡 Documented** | Install dry-run verified. Manifests written. **End-to-end behavior NOT tested.** |
