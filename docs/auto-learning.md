...
- 🔄 **obra/superpowers** (`https://github.com/obra/superpowers`): `abc1234` → `def5678`
- 🔄 **pbakaus/impeccable** (`https://github.com/pbakaus/impeccable`): `xyz9999` → `xyz10000`
```

### State File

`catalog/state.json` (gitignored, regenerated by the workflow):

```json
{
  "sources": {
    "https://github.com/obra/superpowers": "def5678",
    "https://github.com/pbakaus/impeccable": "xyz10000"
  }
}
```
